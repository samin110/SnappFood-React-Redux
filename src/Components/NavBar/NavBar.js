...
function NavBar() {
  const dataFromStore = useSelector(({ usersReducer }) => usersReducer.data);
    ...
    <nav className='menu'>
      <div className='navbar'>
        ...
        <div className='navbar__buttons'>
          ...
          {dataFromStore[0] ? (
            <div className='navbar__login navbar__profile'>
              <Link to='/profile' className='btn-login btn-profile'>
                حساب کاربری
              </Link>
            </div>
          ) : (
            <div className='navbar__login-profile'>
